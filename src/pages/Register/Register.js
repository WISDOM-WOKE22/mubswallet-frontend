...
function Register() {
  ...
  return (<div className="flex m-5 justify-center">
    <div className="register-container card" style={{margin: '10px'}}>
      ...
      <hr id="line"/>
      <form id='registration-form' className='flex-ol justify-center items-center' onSubmit={onFinish}>
         <Row gutter={16}>
          <Col span={12}>
            <Form.Item>
              <input
        ...
        <div className="flex-col items-start">
          ...
          <h1 className="already-member text-xl underline" onClick={() => navigate("/login")}>
          Already a member? Log in
        </h1>
        </div>
      </form>
    </div>
    <div className="go-back flex flex-start" onClick={()=>navigate('/display')}><i class="ri-close-line"></i></div>
    </div>
  );
}
