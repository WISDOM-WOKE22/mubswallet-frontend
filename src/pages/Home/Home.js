...
function Home() {
  ...
  return (
    ...
    <div className="home-header  bg-secondary">
      ...
      <div
        className="account-info card mt-2 mb-2 w100 h-100 gap-1 br-3 flex-col uppercase justify-around card-noShadow"
        style={{
          alignItems: "start",
          // width: "85%",
      ...
      >
        <div className="flex m-1" style={{ flexWrap: "wrap", backgroundColor: "#000", border: "2px solid black", borderRadius: "10px"}}>
          <h1 className="text-md text-white" style={{ paddingRight: "10px" , backgroundColor: "#000"}}>
            Account Number :
          </h1>
          <h1 className="text-md text-white">{user.id}</h1>
        </div>
        <div className="flex m-1" style={{ flexWrap: "wrap", backgroundColor: "#000", border: "2px solid black", borderRadius: "10px" }}>
          <h1 className="text-md text-white" style={{ paddingRight: "15px" }}>
            Balance :
          </h1>
      ...
      <div className="general-btns-home">
        <div className="general-btn">
          <button>Buy Airtime <i class="ri-arrow-left-down-line"></i></button>
          <button>Buy Data <i class="ri-database-line"></i></button>
          <button>Betting <i class="ri-football-line"></i></button>
        
        </div>
        <div className="general-btn">
          <button>Electricity <i class="ri-lightbulb-flash-line"></i></button>
          <button>Internet <i class="ri-ie-line"></i></button>
          <button>Tv <i class="ri-tv-line"></i></button>
        </div>
        <div className="general-btn">
          <button>Shopping <i class="ri-store-line"></i></button>
          <button>Travel & Hotel <i class="ri-ancient-pavilion-line"></i></button>
          <button>Bank Card <i class="ri-bank-card-line"></i></button>
        </div>
